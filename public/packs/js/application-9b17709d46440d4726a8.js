...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      allData(data);
      console.log(initialMapData); // Create map
      ...
      map = new mapboxgl.Map({
        ...
        // style URL
        center: [initialMapData.last().latitude, initialMapData.last().longitude],
        zoom: 5
      });
...
/******/ });
//# sourceMappingURL=application-9b17709d46440d4726a8.js.map