...
function updateTimeSinceLastUpdate() {
  console.log($("#last-update").innerText);
  $("#last-update").innerText = String(parseInt($("#last-update").innerText) + 1);
}
...
/******/ });
//# sourceMappingURL=application-2106ae3b17c7924bd047.js.map