...
function newData(data) {
  ...
  console.log(data.timestamp, parseFloat(data.timestamp)); // Add pair to lines
  ...
  map.jumpTo({
    center: latlngPairs.last() // zoom: 3,
...
/******/ });
//# sourceMappingURL=application-eb117da7e04c74a6ba56.js.map