...
function formatUnixTime(args) {
  var onlyHours = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var value = args.value;
  var date = new Date(value * 1000);
  console.log("".concat(date.getMinutes(), ":").concat(date.getSeconds()));
  if (!onlyHours) return "".concat(date.getHours(), ":").concat(date.getMinutes(), ":").concat(date.getSeconds());else return "".concat(date.getMinutes(), ":").concat(date.getSeconds());
}
...
/******/ });
//# sourceMappingURL=application-f872ed258e005b855bfc.js.map